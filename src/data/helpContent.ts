/**
 * Help Center content — generated from the official ChurchGeniusPro User Manual
 * (ChurchGeniusPro_User_Manual.docx). Regenerate when the manual changes.
 */

export interface HelpArticle {
  id: string;
  title: string;
  /** Paragraphs; entries starting with '\u2022 ' render as list items. */
  body: string[];
}
...
export const helpSections: HelpSection[] = [
  {
    ...
    icon: 'rocket',
    description: 'What ChurchGeniusPro is, who it\'s for, and your first login.',
    articles: [
      {
        id: 'overview',
        title: 'Overview',
      ...
      {
        id: 'what-is-church-genius-pro',
        title: 'What is Church Genius Pro?',
        body: [
      ...
      {
        id: 'logging-in-for-the-first-time',
      ...
      {
        id: 'logging-out-and-session-safety',
        title: 'Logging out and session safety',
        body: [
  ...
  },
  {
    ...
    icon: 'user-cog',
    description: 'User accounts, families and members, groups, applications, email preferences, and Stripe giving.',
    articles: [
      {
        id: 'overview',
        title: 'Overview',
      ...
      {
        id: 'adding-families-and-members',
        title: 'Adding families and members',
        body: [
          'Why families?',
      ...
      {
        id: 'groups-and-group-emails',
        title: 'Groups and group emails',
        body: [
      ...
      {
        id: 'email-preferences-and-unsubscribes',
        title: 'Email preferences and unsubscribes',
        body: [
      ...
      {
        id: 'stripe-integration-online-giving',
        title: 'Stripe Integration (Online Giving)',
        body: [
  ...
  {
    id: 'pastor-ministry-leader-guide',
    title: 'Pastor & Ministry Leader Guide',
    icon: 'heart-handshake',
    description: 'Meetings, events, ministries, prayer, worship planning, congregation email, and follow-ups.',
    articles: [
      {
        id: 'overview',
        title: 'Overview',
      ...
      {
        id: 'sending-emails-to-the-congregation',
        title: 'Sending emails to the congregation',
        body: [
  ...
  },
  {
    ...
    icon: 'calculator',
    description: 'Categories, income and expenses, pledge campaigns, online donations, and reports.',
    articles: [
      {
        id: 'overview',
        title: 'Overview',
      ...
      {
        id: 'setting-up-your-accounting-categories',
        title: 'Setting up your accounting categories',
        body: [
      ...
      {
        id: 'recording-income-contributions',
        title: 'Recording income (contributions)',
        body: [
      ...
      {
        id: 'online-and-text-donations',
        title: 'Online and text donations',
        body: [
      ...
      {
        id: 'reviewing-online-donations',
        title: 'Reviewing online donations',
        body: [
  ...
  },
  {
    ...
    icon: 'hand-helping',
    description: 'Assignments, accepting or declining requests, your volunteer profile, and special roles.',
    articles: [
      {
        id: 'overview',
        title: 'Overview',
      ...
      {
        id: 'where-to-find-your-volunteer-assignments',
        title: 'Where to find your volunteer assignments',
        body: [
      ...
      {
        id: 'accepting-or-declining-a-request',
      ...
      {
        id: 'updating-your-volunteer-profile',
        title: 'Updating your volunteer profile',
        body: [
  ...
  {
    id: 'member-guide-my-profile',
    title: 'Member Guide (My Profile)',
    icon: 'circle-user',
    description: 'Your dashboard, profile, giving, groups, chat, directory, classes, and volunteering.',
    articles: [
      {
        id: 'overview',
        title: 'Overview',
      ...
      {
        id: 'contributions-and-pledges',
        title: 'Contributions and Pledges',
        body: [
  ...
  {
    id: 'parents-the-kids-portal',
    title: 'Parents & the Kids Portal',
    icon: 'baby',
    description: 'Registering children, secure check-in and pick-up, lessons, and parent alerts.',
    articles: [
      {
        id: 'overview',
        title: 'Overview',
      ...
      {
        id: 'registering-your-child',
        title: 'Registering your child',
        body: [
      ...
      {
        id: 'checking-your-child-in-at-church',
        title: 'Checking your child in at church',
        body: [
      ...
      {
        id: 'picking-your-child-up',
        title: 'Picking your child up',
        body: [
      ...
      {
        id: 'the-kids-portal-for-older-children',
        title: 'The Kids Portal (for older children)',
        body: [
      ...
      {
        id: 'alerts-for-parents',
        title: 'Alerts for parents',
        body: [
  ...
  },
  {
    ...
    icon: 'bell',
    description: 'Email, event and periodic reminders, push notifications, and the event calendar.',
    articles: [
      {
        id: 'overview',
        title: 'Overview',
  ...
  {
    id: 'system-administrator-tools',
    title: 'System Administrator Tools',
    icon: 'settings',
    description: 'Registering church clients and platform-level administration.',
    articles: [
      {
        id: 'overview',
        title: 'Overview',
      ...
      {
        id: 'registering-a-new-church-client',
        title: 'Registering a new church client',
        body: [
      ...
      {
        id: 'database-backup-configuration',
      ...
      {
        id: 'loading-test-demo-data',
        title: 'Loading test / demo data',
        body: [
  ...
  },
  {
    ...
    icon: 'lightbulb',
    description: 'Practical habits that keep your church data clean and your team fast.',
    articles: [
      {
        id: 'overview',
        title: 'Overview',
      ...
      {
        id: 'for-pastors-and-ministry-leaders',
        title: 'For pastors and ministry leaders',
        body: [
  ...
  },
  {
    ...
    icon: 'book-open',
    description: 'Plain-English definitions of terms used across ChurchGeniusPro.',
    articles: [
      {
        id: 'overview',
        title: 'Appendix A — Glossary',
  ...
  {
    id: 'technology-stack',
    title: 'Appendix B — Technology Stack',
    icon: 'server',
    description: 'The technology behind the platform: backend, frontend, integrations, security, scalability.',
    articles: [
      {
        id: 'overview',
        title: 'Overview',
  ...
  {
    id: 'getting-help',
    title: 'Appendix C — Getting Help',
    icon: 'life-buoy',
    description: 'Where to turn when you\'re stuck — in-app help, your administrator, and the support team.',
    articles: [
      {
        id: 'overview',
        title: 'Overview',
      ...
      {
        id: 'from-your-church-administrator',
        title: 'From your church administrator',
        body: [
      ...
      {
        id: 'from-the-support-team',
        title: 'From the support team',
        body: [
